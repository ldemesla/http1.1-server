...
unless (caller) {
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '/Users/mabois/Documents/tls/openssl/util/perl';
        use OpenSSL::fallback '/Users/mabois/Documents/tls/openssl/external/perl/MODULES.txt';
        use OpenSSL::Template;

        my $prepend = <<"_____";
use File::Spec::Functions;
use lib '/Users/mabois/Documents/tls/openssl/util/perl';
use lib '/Users/mabois/Documents/tls/openssl/Configurations';
use lib '.';
use platform;
_____
